...
* Check the size of the address book (using the command `count`)
...
== Count the number of entries : `count`

Check how many unique contacts are stored in the address book.
Format: `count`
